...
export const CaseStudiesClient = ({ caseStudies }: CaseStudyListProps) => {
  ...
  return (
    <section className="wrapper flex flex-col gap-8 px-4 py-8">
      <div className="flex flex-wrap justify-between gap-4">
        <div className="flex items-center gap-4">
          ...
          >
            Show all{" "}
            <span className="absolute -right-2 -bottom-2 -left-2 h-1 origin-left rounded-full bg-black transition-colors duration-300 group-hover:bg-[#F5B341]"></span>
          </button>
        </div>
